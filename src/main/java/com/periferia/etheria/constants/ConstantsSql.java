...
public enum ConstantsSql {
	...
	VAR_SENTENCIA_SQL_EMAIL("SELECT u.cedula, u.first_name, u.last_name, u.email, u.password, u.token FROM etheria.users u WHERE email = ?"),
	...
	VAR_SENTENCIA_SQL_SAVE_USER("INSERT INTO etheria.users (cedula, first_name, last_name, email, password) VALUES (?, ?, ?, ?, ?)"),
